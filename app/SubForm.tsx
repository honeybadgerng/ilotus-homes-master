...
export default function ScheduleInspection() {
  ...
  return (
    ...
    >
      ...
      <Text style={styles.label}>Next of Kin's information</Text>
      <Controller
        control={control}
        rules={{ required: "Next of Kin's name is required" }}
        render={({ field: { onChange, onBlur, value } }) => (
          <TextInput
            style={styles.input}
      ...
      />
      {errors.nextOfKin && (
        <Text style={styles.error}>{errors.nextOfKin.message}</Text>
      )}
      {/* Next of kin Phone Number */}
      <Text style={styles.label}>Next of Kin's Phone Number</Text>
      <Controller
        control={control}
        render={({ field: { onChange, onBlur, value } }) => (
          <TextInput
